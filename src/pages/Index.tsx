...
import LavenderCurtain from '@/components/LavenderCurtain';
...
const Index = () => {
  ...
  // Función que se ejecuta cuando la cortina se abre
  ...
  // Prevenir scroll mientras la cortina está activa
  useEffect(() => {
    if (showCurtain) {
  ...
  return (
    <div className="min-h-screen">
      {/* Cortina de lavanda */}
      {showCurtain && (
        <LavenderCurtain onOpen={handleCurtainOpen} />
      )}

      {/* Contenido principal - se muestra después de que la cortina se abre */}
